...
const TAB_GROUPS = [
  { label:null, tabs:[
    ...
    { k:'group',      l:'Group Structure', icon:'◎' },
  ]},
  { label:'Maritime', tabs:[
    ...
    { k:'hse',        l:'HSE',             icon:'⊕' },
    { k:'pool',       l:'Pool Earnings',   icon:'⊞' },
    { k:'bunker',     l:'Bunkering',       icon:'⛽' },
    { k:'awards',     l:'Awards',          icon:'🏆' },
  ]},
  { label:'Finance', tabs:[
    { k:'zoho',       l:'Zoho ERP',        icon:'⊟' },
    { k:'assumptions',l:'Scenario Mapper', icon:'⊠' },
    { k:'market',     l:'Market Intel',    icon:'◈' },
  ]},
  { label:'Risk', tabs:[
...
export default function App() {
  ...
  return (
    <div style={{ background:C.bg, minHeight:'100vh', color:C.text }}>
      ...
      <div style={{ padding:'20px 24px',maxWidth:1440,margin:'0 auto',paddingRight:assistant?430:24,transition:'padding-right 0.3s' }}>
